...
@dataclass
class FairseqAdabeliefConfig(FairseqDataclass):
    adam_betas: str = field(
        default="(0.9, 0.999)", metadata={"help": "betas for Adam optimizer"}
    )
    adam_eps: float = field(
        default=1e-16, metadata={"help": "epsilon for Adam optimizer"}
    )
...
@register_optimizer("adabelief", dataclass=FairseqAdabeliefConfig)
class FairseqAdabeleif(FairseqOptimizer):
...
class AdaBelief(torch.optim.Optimizer):
    ...
    def __init__(self, params, lr=1e-5, betas=(0.9, 0.999), eps=1e-16,
                 weight_decay=1e-4, amsgrad=False, weight_decouple=True,
