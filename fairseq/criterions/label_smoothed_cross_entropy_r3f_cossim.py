...
@register_criterion("label_smoothed_cross_entropy_r3f_cossim")
class LMCE_R3F_cossim_Criterion(FairseqCriterion):
    def __init__(
    ...
    def forward(self, model, sample, reduce=True, wolog=False,
        ...
        # TODO cos sim loss adding
        # if is_cossim:
        if is_cossim:
            # SBERTmodel = SentenceTransformer('stsb-roberta-large')
            ...
            if cnt % 200 == 0:
                ...
                print('R3F : {}'.format(self.r3f_lambda * symm_kl))
