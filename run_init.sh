...
#TRAIN_FILE=fairseq_cli/train2.py
#TRAIN_FILE=fairseq_cli/train_rouge_val_wolog.py
...
SAVE_DIR1=./checkpoints_low/cnndmlow${VERSION}_${SEED}_${CRITERIONN}_${STOP_CRITERIA}_${ATTN_CHANGE}_from${model_from}_dev${DEVICE}
#SAVE_DIR1=./checkpoints_low/cnndmlow${VERSION}_seed${SEED}_${ATTN_CHANGE}${RATE}_from${model_from}_${CRITERIONN}_${OPTIM}_${STOP_CRITERIA}_dev${DEVICE}
