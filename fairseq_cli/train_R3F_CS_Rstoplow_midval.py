...
def main(cfg: DictConfig, args_ud=None) -> None:
    ...
    while epoch_itr.next_epoch_idx <= max_epoch:
        ...
        # train for one epoch
        valid_losses, should_stop, best_val_loss, cur_patience = train(cfg, trainer, task, epoch_itr,
                                                                       val_by_rouge=is_val_by_rouge,
                                                                       orig_state=orig_state_dict,
                                                                       is_rouge_rl=is_rouge_rl,
                                                                       is_wolog=is_wo_log, is_cossim=is_cossim,
                                                                       emb_model=emb_model, bpe=bpe_ud,
